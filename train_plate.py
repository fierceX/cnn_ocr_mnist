...
def train():
    ...
    batch_size = 96
    data_train = OCRIter(100000, batch_size, 7, 30, 120)
    data_test = OCRIter(1000, batch_size,7, 30, 120)

    _, arg_params, __ = mx.model.load_checkpoint("cnn-ocr", 50)
    ...
    model.fit(
        ...
        optimizer_params={'learning_rate': 0.0015, 'wd': 0.00001, 'momentum':0.9},
